...
param(
 ...
 [string]
 $templateFilePath = "https://raw.githubusercontent.com/alankarmehta/BigDataAutomation/master/predeploy/AnsibleTower/ansibletowervm.json",
...
# Register RPs
$resourceProviders = @("microsoft.network","microsoft.storage","microsoft.compute","microsoft.sqlvirtualmachine");
